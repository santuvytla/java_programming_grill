...
The second line of each test case contains n integers a1,…,an (0≤ai≤n) — elements of the array. Note that they don't have to be distinct.
...
The second line must contain k integers x1,…,xk (1≤xi≤n), where xi is the index chosen for the i-th operation.
